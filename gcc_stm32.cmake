...
SET(CMAKE_C_FLAGS_RELEASE "-O3 -g -flto" CACHE INTERNAL "c compiler flags release")
SET(CMAKE_CXX_FLAGS_RELEASE "-O3 -g -flto" CACHE INTERNAL "cxx compiler flags release")
...
FUNCTION(STM32_SET_TARGET_PROPERTIES TARGET)
    ...
    MESSAGE(STATUS "${STM32_CHIP} has ${STM32_FLASH_SIZE}iB of flash memory and ${STM32_RAM_SIZE}iB of RAM + ${STM32_CCRAM_SIZE}iB of CCM RAM")
ENDFUNCTION()
