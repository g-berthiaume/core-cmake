...
FUNCTION(ADD_DEPLOY_TARGETS TARGET)
    ...
    ADD_CUSTOM_TARGET(deploy DEPENDS ${TARGET} 
        ...
        COMMAND CoreHexCRC.py "${TARGET}_${MODULE_NAME}_${WRKS_GIT_DESC}_${CORE_GIT_DESC}.hex" ${BOOTLOADER_SIZE} > ${TARGET}_${MODULE_NAME}_${WRKS_GIT_DESC}_${CORE_GIT_DESC}.crc
    )
ENDFUNCTION()
