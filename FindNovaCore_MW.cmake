...
IF( CORE_USE_RTCANTRANSPORT )
  SET( TRANSPORT_SOURCES
    ${NOVA_CORE_MW_ROOT}/src/transport/RTCANTransport.cpp
    ${NOVA_CORE_MW_ROOT}/src/transport/RTCANPublisher.cpp
    ${NOVA_CORE_MW_ROOT}/src/transport/RTCANSubscriber.cpp
  )
  
  LIST( APPEND NOVA_CORE_MW_SOURCES ${TRANSPORT_SOURCES} )
ENDIF()

IF( CORE_USE_DEBUGTRANSPORT )
  SET( TRANSPORT_SOURCES
    ${NOVA_CORE_MW_ROOT}/src/transport/DebugTransport.cpp
    ${NOVA_CORE_MW_ROOT}/src/transport/DebugPublisher.cpp
    ${NOVA_CORE_MW_ROOT}/src/transport/DebugSubscriber.cpp
  )
...
IF( CORE_USE_BOOTLOADER )
  SET( BOOTLOADER_SOURCES
    ${NOVA_CORE_MW_ROOT}/src/Bootloader.cpp

    ${NOVA_CORE_MW_ROOT}/port/chibios/src/impl/Bootloader_.cpp
    ${NOVA_CORE_MW_ROOT}/port/chibios/src/impl/Flasher_.cpp
  )
  
  LIST( APPEND NOVA_CORE_MW_SOURCES ${BOOTLOADER_SOURCES} )
ENDIF()
