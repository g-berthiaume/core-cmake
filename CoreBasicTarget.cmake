...
MACRO( core_basic_target_module )
...
IF( CORE_TARGET_UNPARSED_ARGUMENTS )
  MESSAGE( FATAL_ERROR "CORE_BASIC_TARGET_MODULE() called with unused arguments: ${CORE_TARGET_UNPARSED_ARGUMENTS}" )
ENDIF()

ENABLE_LANGUAGE( ASM )

MESSAGE( STATUS "Core Basic Target Module: ${CORE_TARGET_MODULE}" )
MESSAGE( STATUS "Core Basic Target Name: ${CORE_TARGET_NAME}" )
MESSAGE( STATUS "Core Basic Target OS Version: ${CORE_TARGET_OS_VERSION}" )
MESSAGE( STATUS "Core Basic Target Packages: ${CORE_MODULE_PACKAGES}" )

IF(${CORE_TARGET_IS_BOOTLOADER})
  MESSAGE( STATUS "Core Basic Target IS BOOTLOADER" )
...
MESSAGE( STATUS "Core Basic Target Module Name: ${MODULE_NAME}" )
